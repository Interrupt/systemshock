...
typedef uchar (*hotkey_callback)(ushort keycode, ulong context, intptr_t state); 
...
errtype hotkey_add(ushort keycode, ulong context_mask, hotkey_callback func, intptr_t state);
...
#ifdef HOTKEY_HELP
errtype hotkey_add_help(ushort keycode, ulong context_mask, hotkey_callback func, intptr_t state, char *help_text);

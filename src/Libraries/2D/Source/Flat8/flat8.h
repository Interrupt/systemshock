...
extern void flat8_fix_ucline(fix x0, fix y0, grs_rgb c0, fix x1, fix y1,
                             grs_rgb c1);
...
extern void flat8_clut_lin_umap(grs_bitmap *bm, int n, grs_vertex **vpl,
                                uchar *cl);
extern void flat8_flat8_solid_lin_umap(grs_bitmap *bm, int n, grs_vertex **vpl,
                                       int c);
...
extern void flat8_flat8_clut_wall_umap(grs_bitmap *bm, int n, grs_vertex **vpl,
                                       uchar *cl);
...
extern void flat8_flat8_clut_floor_umap(grs_bitmap *bm, int n, grs_vertex **vpl,
                                        uchar *cl);
...
extern int flat8_flat8_clut_per_umap(grs_bitmap *bm, int n, grs_vertex **vpl,
                                     uchar *cl);
extern int flat8_flat8_solid_per_umap(grs_bitmap *bm, int n, grs_vertex **vpl,
                                      int c);

extern void flat8_lin_lit_utmap(int n, fix *vlist, grs_bitmap *bm, fix *m,
                                fix *l);

extern void flat8_scale_ubitmap(grs_bitmap *bm, short x, short y, short w,
                                short h);
extern int flat8_scale_bitmap(grs_bitmap *bm, short x, short y, short w,
                              short h);

extern void flat8_mono_scale_ubitmap(grs_bitmap *bm, short x, short y, short w,
                                     short h);
extern int flat8_mono_scale_bitmap(grs_bitmap *bm, short x, short y, short w,
                                   short h);

extern void flat8_rsd8_scale_ubitmap(grs_bitmap *bm, short x, short y, short w,
                                     short h);
extern int flat8_rsd8_scale_bitmap(grs_bitmap *bm, short x, short y, short w,
                                   short h);

extern void flat8_flat8_clut_scale_ubitmap(grs_bitmap *bm, short x, short y,
                                           short w, short h, uchar *cl);

extern void flat8_rsd8_clut_scale_ubitmap(grs_bitmap *bm, short x, short y,
                                          short w, short h, uchar *cl);
extern int flat8_rsd8_clut_scale_bitmap(grs_bitmap *bm, short x, short y,
                                        short w, short h, uchar *cl);

extern void flat8_rsd8_scale_solid_ubitmap(grs_bitmap *bm, short x, short y,
                                           short w, short h, int c);
extern int flat8_rsd8_scale_solid_bitmap(grs_bitmap *bm, short x, short y,
                                         short w, short h, int c);

extern void flat8_tluc8_scale_ubitmap(grs_bitmap *bm, short x, short y, short w,
                                      short h);
extern int flat8_tluc8_scale_bitmap(grs_bitmap *bm, short x, short y, short w,
                                    short h);
...
int gri_trans_solid_scale_umap_init(grs_tmap_loop_info *info,
                                    grs_vertex **vert);
...
extern void flat8_flat8_clut_ubitmap(grs_bitmap *bm, short x, short y,
                                     uchar *cl);
...
extern void flat8_clut_hflip_flat8_ubitmap(grs_bitmap *bm, short x, short y,
                                           uchar *cl);

/* device-specific routines. */
extern short flat8_calc_row(short w);
extern grs_bitmap *flat8_sub_bitmap(grs_bitmap *bm, short x, short y, short w,
                                    short h);

/* bitmap doubling routines. */
extern void flat8_flat8_h_double_ubitmap(grs_bitmap *bm);
extern void flat8_flat8_smooth_h_double_ubitmap(grs_bitmap *srcb,
                                                grs_bitmap *dst);

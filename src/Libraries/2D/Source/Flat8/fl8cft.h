...
(ptr_type) flat8_clut_set_upixel, /* pixel primitve */
    ...
    (ptr_type)gri_flat8_mask_fill_clut_bitmap
    ,                                      /* stencil clipped bitmap blitter */
    ...
    (ptr_type)gr_not_imp, //### MLA- not supposed to be used
                          //gri_opaque_clut_true_lin_umap_init,   /* Linear
                          //mappers */
    gr_null, gr_null, gr_null,
    (ptr_type)gr_not_imp
    , //### MLA- not supposed to be used   gri_opaque_clut_true_lin_umap_init,
    gr_null,

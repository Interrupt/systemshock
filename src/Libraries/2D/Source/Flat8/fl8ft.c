...
void (*flat8_function_table[GRD_FILL_TYPES][GRD_FUNCS * REAL_BMT_TYPES])() = {
    {
        ...
        (ptr_type)gri_trans_scale_umap_init, gr_null, gr_null,
        ...
        (ptr_type)rsd8_tm_init, (ptr_type)rsd8_tm_init, (ptr_type)rsd8_tm_init,
        (ptr_type)rsd8_tm_init, (ptr_type)rsd8_tm_init,
        ...
        (ptr_type)rsd8_pm_init, (ptr_type)rsd8_pm_init, (ptr_type)rsd8_pm_init,
        (ptr_type)rsd8_pm_init, (ptr_type)rsd8_pm_init,
        ...
        (ptr_type)gri_tluc8_trans_scale_umap_init, gr_null, gr_null,
        ...
        (ptr_type)gri_tluc8_trans_lin_umap_init, gr_null, gr_null,
    ...
    },
    {
        ...
        (ptr_type)gri_trans_lin_umap_init, (ptr_type)gri_opaque_lit_lin_umap_init,
        (ptr_type)gri_trans_lit_lin_umap_init,
        (ptr_type)gri_opaque_clut_lin_umap_init,
        (ptr_type)gri_trans_clut_lin_umap_init,
    ...
    },
    {
        ...
        gr_null, (ptr_type)gri_solid_poly_init, gr_null,
        (ptr_type)gri_solid_poly_init, gr_null,

        (ptr_type)gri_solid_poly_init, /* Bilinear */
        (ptr_type)gri_trans_solid_lin_umap_init, (ptr_type)gri_solid_poly_init,
        (ptr_type)gri_trans_solid_lin_umap_init, (ptr_type)gri_solid_poly_init,
        ...
        (ptr_type)gri_trans_solid_wall_umap_init, (ptr_type)gri_solid_poly_init,
        (ptr_type)gri_trans_solid_wall_umap_init, (ptr_type)gri_solid_poly_init,
        ...
        (ptr_type)gri_opaque_solid_scale_umap_init, (ptr_type)rsd8_tm_init,
        (ptr_type)gri_opaque_solid_scale_umap_init, (ptr_type)rsd8_tm_init,
        (ptr_type)gri_opaque_solid_scale_umap_init, (ptr_type)rsd8_tm_init,
        ...
        (ptr_type)gri_solid_poly_init, /* Linear mappers */
        (ptr_type)rsd8_tm_init, (ptr_type)gri_solid_poly_init,
        (ptr_type)rsd8_tm_init, (ptr_type)gri_solid_poly_init,
        (ptr_type)rsd8_tm_init,
        ...
        (ptr_type)gri_solid_poly_init, /* Perspective -hscan */
        (ptr_type)rsd8_pm_init, (ptr_type)gri_solid_poly_init,
        (ptr_type)rsd8_pm_init, (ptr_type)gri_solid_poly_init,

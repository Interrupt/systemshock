...
physics_handle EDMS_make_marble(Marble *m, State *s) {
    ...
    init_state[3][0] = init_state[3][1] = init_state[4][0] = init_state[4][1] = init_state[5][0] = init_state[5][1] =
        END;

...
int32_t make_biped(Q init_state[6][3], Q params[10], Q skeleton_pointer[]) {
    ...
    //	=======================================
    extern Q save_r_w_r[MAX_OBJ][3], save_r_w_l[MAX_OBJ][3], save_chi[MAX_OBJ];

    //	Counters...
    //	===========
    extern int not_yet1[MAX_OBJ], not_yet2[MAX_OBJ], not_yet3[MAX_OBJ];

    //	Have some variables...
    //	======================
    int object_number = -1, // Three guesses...
        error_code = -1;    // Guilty until...
    Q temp_r[3] = {0, 0, 0}, temp_l[3] = {0, 0, 0};
    ...
    if (object_number < MAX_OBJ) {
        ...
        //		===========================================
        for (int copy = 0; copy < DOF_MAX; copy++)
            I[object_number][copy] = 0;
        ...
        I[object_number][13] = I[object_number][14] =
            I[object_number][20] * (I[object_number][23] * I[object_number][23] / 4. +
        ...
        equation_of_motion[object_number][0] = equation_of_motion[object_number][1] =
            equation_of_motion[object_number][2] = equation_of_motion[object_number][3] =
                equation_of_motion[object_number][4] = equation_of_motion[object_number][5] = null_function;

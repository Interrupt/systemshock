...
//	=================================================
static Q cos_alpha, cos_beta, cos_gamma, sin_alpha, sin_beta, sin_gamma;
...
void make_biped_skeleton(int object) {
    ...
    //	-----------------------------
    Q xi_alpha = utility_pointer[object][27], xi_beta = utility_pointer[object][28];
    ...
    globalize_S( // Right then left...
        utility_pointer[object][0], utility_pointer[object][1], utility_pointer[object][2]);

    globalize_S(utility_pointer[object][3], utility_pointer[object][4], utility_pointer[object][5]);

    //	Heels...
    //	--------
    globalize_S(utility_pointer[object][6], utility_pointer[object][7], utility_pointer[object][8]);

    globalize_S(utility_pointer[object][9], utility_pointer[object][10], utility_pointer[object][11]);

    //	Knees...
    //	--------
    globalize_S(utility_pointer[object][12], utility_pointer[object][13], utility_pointer[object][14]);

    globalize_S(utility_pointer[object][15], utility_pointer[object][16], utility_pointer[object][17]);

    //	Pelvic joints...
    //	----------------
    utility_pointer[object][18] = I[object][23]; // Right then left...
    utility_pointer[object][21] = -I[object][23];
    utility_pointer[object][19] = utility_pointer[object][20] = utility_pointer[object][22] =
        utility_pointer[object][23] = 0;

    globalize_S(utility_pointer[object][18], utility_pointer[object][19], utility_pointer[object][20]);

    globalize_S(utility_pointer[object][21], utility_pointer[object][22], utility_pointer[object][23]);

    //	Center o' mass...
    //	-----------------
    utility_pointer[object][24] = utility_pointer[object][25] = utility_pointer[object][26] = 0;
    ...
    globalize_S(utility_pointer[object][27], utility_pointer[object][28], utility_pointer[object][29]);
    ...
    utility_pointer[object][31] = utility_pointer[object][34] = vert_y;

    utility_pointer[object][32] = utility_pointer[object][35] = vert_z;

    globalize_S(utility_pointer[object][30], utility_pointer[object][31], utility_pointer[object][32]);

    globalize_S(utility_pointer[object][33], utility_pointer[object][34], utility_pointer[object][35]);
    ...
    globalize_S(utility_pointer[object][36], utility_pointer[object][37], utility_pointer[object][38]);

    globalize_S(utility_pointer[object][39], utility_pointer[object][40], utility_pointer[object][41]);
    ...
    globalize_S(utility_pointer[object][42], utility_pointer[object][43], utility_pointer[object][44]);

    globalize_S(utility_pointer[object][45], utility_pointer[object][46], utility_pointer[object][47]);
...
void globalize_S(Q &X, Q &Y, Q &Z) {
    ...
    //	=========================
    X = x * (cos_alpha * cos_gamma) + y * (cos_gamma * sin_alpha * sin_beta - cos_beta * sin_gamma) +
        z * (cos_beta * cos_gamma * sin_alpha + sin_beta * sin_gamma);

    Y = x * (cos_alpha * sin_gamma) + y * (cos_beta * cos_gamma + sin_alpha * sin_beta * sin_gamma) +
        z * (cos_beta * sin_alpha * sin_gamma - cos_gamma * sin_beta);

    Z = x * (-sin_alpha) + y * (cos_alpha * sin_beta) + z * (cos_alpha * cos_beta);
}

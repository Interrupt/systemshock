...
#pragma disable_message(202)
uchar wrapper_options_func(ushort keycode, ulong context, intptr_t data) {
...
//#ifdef NOT_YET //
#pragma disable_message(202)
uchar saveload_hotkey_func(ushort keycode, ulong context, intptr_t data) {
#ifdef DEMO
    return (TRUE);
#else
    if ((!data) && (!can_save()))
...
uchar demo_quit_func(ushort keycode, ulong context, intptr_t data) {

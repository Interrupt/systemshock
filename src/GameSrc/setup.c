...
int diff_x[16] = {DIFF_TITLE1_LEFT1 + 2, DIFF_TITLE1_LEFT2 + 2, DIFF_TITLE1_LEFT3 + 2, DIFF_TITLE1_LEFT4 + 2,
                  DIFF_TITLE2_LEFT1 + 2, DIFF_TITLE2_LEFT2 + 2, DIFF_TITLE2_LEFT3 + 2, DIFF_TITLE2_LEFT4 + 2,
                  DIFF_TITLE3_LEFT1 + 2, DIFF_TITLE3_LEFT2 + 2, DIFF_TITLE3_LEFT3 + 2, DIFF_TITLE3_LEFT4 + 2,
                  DIFF_TITLE4_LEFT1 + 2, DIFF_TITLE4_LEFT2 + 2, DIFF_TITLE4_LEFT3 + 2, DIFF_TITLE4_LEFT4 + 2};

// couldnt at the least this have been of 4, and indexed by [idx>>2]
int diff_y[16] = {DIFF_TITLE1_OPT_TOP + 2, DIFF_TITLE1_OPT_TOP + 2, DIFF_TITLE1_OPT_TOP + 2, DIFF_TITLE1_OPT_TOP + 2,
                  DIFF_TITLE2_OPT_TOP + 2, DIFF_TITLE2_OPT_TOP + 2, DIFF_TITLE2_OPT_TOP + 2, DIFF_TITLE2_OPT_TOP + 2,
                  DIFF_TITLE3_OPT_TOP + 2, DIFF_TITLE3_OPT_TOP + 2, DIFF_TITLE3_OPT_TOP + 2, DIFF_TITLE3_OPT_TOP + 2,
                  DIFF_TITLE4_OPT_TOP + 2, DIFF_TITLE4_OPT_TOP + 2, DIFF_TITLE4_OPT_TOP + 2, DIFF_TITLE4_OPT_TOP + 2};
#endif
...
journey_y[8] = {JOURNEY_OPT1_TOP, JOURNEY_OPT1_BOT, JOURNEY_OPT2_TOP, JOURNEY_OPT2_BOT,
...
errtype journey_credits_func(uchar draw_stuff) {
    ...
    if (draw_stuff) {
        ...
        if (WonGame_ShowStats) {WonGame_ShowStats = 0; PrintWinStats();}
        PrintCredits();

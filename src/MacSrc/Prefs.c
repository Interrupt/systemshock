...
#ifdef AUDIOLOGS
extern uchar audiolog_cancel_func(ushort keycode, ulong context, intptr_t data);
#endif
extern uchar posture_hotkey_func(ushort keycode, ulong context, intptr_t data);
extern uchar toggle_mouse_look(ushort keycode, ulong context, intptr_t data);
extern uchar change_mode_func(ushort keycode, ulong context, intptr_t data);
extern uchar clear_fullscreen_func(ushort keycode, ulong context, intptr_t data);
extern uchar saveload_hotkey_func(ushort keycode, ulong context, intptr_t data);
extern uchar pause_game_func(ushort keycode, ulong context, intptr_t data);
extern uchar reload_weapon_hotkey(ushort keycode, ulong context, intptr_t data);
extern uchar select_grenade_hotkey(ushort keycode, ulong context, intptr_t data);
extern uchar toggle_olh_func(ushort keycode, ulong context, intptr_t data);
extern uchar select_drug_hotkey(ushort keycode, ulong context, intptr_t data);
extern uchar toggle_music_func(ushort keycode, ulong context, intptr_t data);
extern uchar demo_quit_func(ushort keycode, ulong context, intptr_t data);
extern uchar cycle_weapons_func(ushort keycode, ulong context, intptr_t data);
extern uchar MacDetailFunc(ushort keycode, ulong context, intptr_t data);
extern uchar toggle_opengl_func(ushort keycode, ulong context, intptr_t data);
extern uchar arm_grenade_hotkey(ushort keycode, ulong context, intptr_t data);
extern uchar use_drug_hotkey(ushort keycode, ulong context, intptr_t data);
extern uchar hud_color_bank_cycle(ushort keycode, ulong context, intptr_t data);
extern uchar olh_overlay_func(ushort keycode, ulong context, intptr_t data);
extern uchar keypad_hotkey_func(ushort keycode, ulong context, intptr_t data);
extern uchar MacHelpFunc(ushort keycode, ulong context, intptr_t data);
extern uchar wrapper_options_func(ushort keycode, ulong context, intptr_t data);
extern uchar toggle_giveall_func(ushort keycode, ulong context, intptr_t data);
extern uchar toggle_physics_func(ushort keycode, ulong context, intptr_t data);
extern uchar toggle_up_level_func(ushort keycode, ulong context, intptr_t data);
extern uchar toggle_down_level_func(ushort keycode, ulong context, intptr_t data);
...
{
  const char *s; ulong contexts; hotkey_callback func; intptr_t state; bool used; int def1, def2;
} HOTKEYLOOKUP;
